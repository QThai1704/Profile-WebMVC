...
public class AchievementController {
    ...
    // Create
    @PostMapping("/profile/achievement/create")
    public String postCreateAchievement(@ModelAttribute("newAchievement") Achievement newAchievement) {
        ...
        return "redirect:/profile/achievement";
    }

    // Update
    @GetMapping("/profile/achievement/{id}")
    public String getUpdateAchievemen(Model model, @PathVariable("id") long id) {
        ...
        return "candidate/achievement/update";
    }

    @PostMapping("/profile/achievement/update")
