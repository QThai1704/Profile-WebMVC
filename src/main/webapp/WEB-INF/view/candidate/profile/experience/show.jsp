              ...
              <tr>
                ...
                <td>
                  <div class="text-center">
                    <a type="button" class="btn btn-warning" href="/profile/experience/${experience.id}">
                      Chỉnh sửa
                    </a>
                    <a type="button" class="btn btn-danger" href="/profile/experience/delete/${experience.id}">
                      Xóa
                    </a>
                  </div>
                </td>
