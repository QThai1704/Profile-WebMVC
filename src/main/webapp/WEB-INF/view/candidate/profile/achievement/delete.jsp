    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <body>
                ...
                <form:form action="/user/profile/achievement/delete" method="POST" modelAttribute="deleteAchievement">
                    <div class="container">
                        <div class="row">
                            <div class="my-3">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="alert alert-danger text-center" role=" alert">
                                    Bạn có chắc chắn muốn xóa <span class="fw-bold">thành tích</span> này không?
                                </div>
                            </div>
                            <div class="col-12 text-center mb-5">
                                <a type="button" class="btn btn-danger" href="/profile/achievement">
                                    Hủy
                                </a>
