            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="text-center">
                  <a href="/profile/target" class="btn btn-outline-success">Xem</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="text-center">
                  <a href="/profile/skill" class="btn btn-outline-success">Xem</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="text-center">
                  <a href="/profile/portfolio" class="btn btn-outline-success">Xem</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="text-center">
                  <a href="/profile/experience" class="btn btn-outline-success">Xem</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="text-center">
                  <a href="/profile/achievement" class="btn btn-outline-success">Xem</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="text-center">
                  <a href="/profile/society" class="btn btn-outline-success">Xem</a>
                </div>
              </div>
            </div>
          </div>
