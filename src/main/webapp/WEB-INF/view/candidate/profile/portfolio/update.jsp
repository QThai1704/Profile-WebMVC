    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <body>
                ...
                <form:form action="/profile/portfolio/update" method="POST" enctype="multipart/form-data"
                    modelAttribute="updatePortfolio">
                    <div class="container">
                        <div>
                            <div class="my-3">
                            ...
                            <div class="mb-3 text-center">
                                <img style="max-height: 250px" alt="avatar preview"
                                    src="/images/profile/${updatePortfolio.image}" />
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <form:input type="text" class="form-control" placeholder="Đường dẫn tới Github"
                                    path="github" />
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="text-center mb-3">
                            <a type="button" class="btn btn-danger" href="/profile/portfolio">
                                Hủy
                            </a>
