  ...
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
      ...
      <body>
        ...
        <form:form class="modal" id="myModal" action="/profile/portfolio/create" method="POST"
          enctype="multipart/form-data" modelAttribute="newPortfolio">
          ...
          <tbody>
            <c:forEach var="portfolio" items="${portfolios}">
              <tr>
                ...
                <td><a href="${portfolio.website}">${portfolio.website}</a></td>
                <td>
                  <div class="text-center">
                    <a type="button" class="btn btn-success" href="/profile/portfolio/detail/${portfolio.id}">
                      Xem chi tiết
                    </a>
                    <a type="button" class="btn btn-warning" href="/profile/portfolio/${portfolio.id}">
                      Chỉnh sửa
                    </a>
                    <a type="button" class="btn btn-danger" href="/profile/portfolio/delete/${portfolio.id}">
                      Xóa
                    </a>
                  </div>
                </td>
