                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody class="text-start">
                        <tr>
                            ...
                            <td>${detailPortfolio.name}</td>
                        </tr>
                        <tr>
                            <td class="key-about">Github</td>
                            <td class="information-about">
                                <a href="${detailPortfolio.github}">${detailPortfolio.github}</a>
                            </td>
                        </tr>
                        <tr>
                            <td class="key-about">Website</td>
                            <td class="information-about">
                                <a href="${detailPortfolio.website}">${detailPortfolio.website}</a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <img style="max-height: 200px" alt="avatar preview"
                                    src="/images/profile/${detailPortfolio.image}" />
                            </td>
                        </tr>
                    </tbody>
                </table>
                <div class="text-center mb-3">
                    <a type="button" class="btn btn-warning" href="/profile/portfolio">
                        Quay về
                    </a>
                </div>
