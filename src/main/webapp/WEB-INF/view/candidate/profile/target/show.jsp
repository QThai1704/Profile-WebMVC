    ...
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
      ...
      <body>
        ...
        <form:form class="modal" id="myModal" action="/user/profile/target/create" method="POST"
          modelAttribute="newTarget" enctype="form-data">
        ...
        <table class="table table-striped table-hover">
          <thead>
            <tr class="top-table">
              ...
              <th scope="col" class="col-1">Loại mục tiêu</th>
              ...
              <tr>
                ...
                <td>
                  <div class="text-center">
                    <a type="button" class="btn btn-warning" href="/profile/target/${target.id}">
                      Chỉnh sửa
                    </a>
                    <a type="button" class="btn btn-danger" href="/profile/target/delete/${target.id}">
                      Xóa
                    </a>
                  </div>
                </td>
