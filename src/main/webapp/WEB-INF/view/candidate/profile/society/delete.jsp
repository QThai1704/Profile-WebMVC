    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <body>
                ...
                <form:form action="/user/profile/society/delete" method="POST" modelAttribute="deleteSociety">
                    <div class="container">
                        <div class="row">
                            <div class="my-3">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="alert alert-danger text-center" role=" alert">
                                    Bạn có chắc chắn muốn xóa liên kết mạng xã hội này không?
                                </div>
                            </div>
                            <div class="col-12 text-center mb-5">
                                <a type="button" class="btn btn-danger" href="/profile/society">
                                    Hủy
                                </a>
