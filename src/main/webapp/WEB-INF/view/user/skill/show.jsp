  ...
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
      ...
      <body>
        ...
        <form:form class="modal" id="myModal" action="/user/profile/skill/create" method="POST" enctype="form-data"
          modelAttribute="newSkill">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Thêm kỹ năng cá nhân</h4>
              </div>
              ...
              <tr>
                ...
                <td>
                  <div class="text-center">
                    <a type="button" class="btn btn-warning" href="/user/profile/skill/${skill.id}">
                      Chỉnh sửa
                    </a>
                    <a type="button" class="btn btn-danger" href="/user/profile/skill/delete/${skill.id}">
                      Xóa
                    </a>
                  </div>
                </td>
