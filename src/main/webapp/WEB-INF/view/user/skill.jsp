  ...
  <body>
    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        ...
        <tr>
          <td class="name-skill">CSS</td>
          <td class="level-skill">75</td>
          <td>
            <div class="text-center">
              <button type="button" class="btn btn-info btn-edit-skill" data-bs-toggle="modal"
        ...
        <tr>
          <td class="name-skill">JavaScript</td>
          <td class="level-skill">60</td>
          <td>
            <div class="text-center">
              <button type="button" class="btn btn-info btn-edit-skill" data-bs-toggle="modal"
        ...
        <tr>
          <td class="name-skill">Bootstrap</td>
          <td class="level-skill">75</td>
          <td>
            <div class="text-center">
              <button type="button" class="btn btn-info btn-edit-skill" data-bs-toggle="modal"
        ...
        <tr>
          <td class="name-skill">Photoshop</td>
          <td class="level-skill">70</td>
          <td>
            <div class="text-center">
              <button type="button" class="btn btn-info btn-edit-skill" data-bs-toggle="modal"
